...
export class ChatMainController {
  ...
  stream(
    ...
    @Query('sessionType') sessionType?: 'default' | 'thought' | 'gallery-agent' | 'xhs-specialist',
    @Req() req?: Request,
   ...
   */
  async createSession(
    @Body() body?: { sessionId?: string; sessionType?: 'default' | 'thought' | 'gallery-agent' | 'xhs-specialist' },
    @Req() req?: Request,
